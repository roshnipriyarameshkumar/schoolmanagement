...
class AnnouncementsScreen extends StatefulWidget {
  ...
  const AnnouncementsScreen({Key? key, required this.studentId}) : super(key: key);
...
class _AnnouncementsScreenState extends State<AnnouncementsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final fetchedSchoolId = studentData?['schoolId'] as String?;

      if (fetchedSchoolId == null || fetchedSchoolId.isEmpty) {
        setState(() {
          isLoading = false;
          errorMessage = 'School ID not found for student';
        });
        return;
      }
      ...
      // Filter announcements for students and sort by timestamp
  ...
  // New method to determine the color based on event date proximity
  ...
  String _formatEventDate(dynamic eventDate) {
    try {
      ...
      // I am using this format based on your screenshot, but you can adjust.
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: eventDateColor.withOpacity(0.05), // A lighter shade of the color
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: eventDateColor.withOpacity(0.2), // A slightly darker border
                      width: 1,
                    ),
                  ),
                  child: Row(
