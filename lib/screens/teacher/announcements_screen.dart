// FILE: lib/screens/teacher/announcements_screen.dart
...
class _AnnouncementsScreenState extends State<AnnouncementsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Filter announcements for teachers and all, sort by timestamp
      List<DocumentSnapshot> filteredAnnouncements = announcementsSnapshot.docs
        ...
        return audience == 'all' || audience == 'teachers' || audience == 'teacher';
      }).toList();
      ...
      filteredAnnouncements.sort((a, b) {
        ...
        final aTimestamp = aData?['timestamp'] ?? aData?['createdAt'];
        final bTimestamp = bData?['timestamp'] ?? bData?['createdAt'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Teacher Info Header
          if (teacherData != null) _buildTeacherInfoHeader(),
          // Announcements List
  ...
  Widget _buildTeacherInfoHeader() {
    String teacherName = teacherData?['meta']?['name'] ?? 'Teacher';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'There are no announcements available for teachers at this time.\nCheck back later for updates from your school administration.',
              style: TextStyle(
                fontSize: 16,
  ...
  Widget _buildAnnouncementCard(Map<String, dynamic> data) {
    ...
    String message = data['message']?.toString() ?? data['content']?.toString() ?? 'No Message';
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: audience.toLowerCase() == 'all'
                        ...
                        : audience.toLowerCase().contains('teacher')
